...
function preload(){
  ...
  restartImage = loadImage("Images/restartButton.png");
...
function setup() {
  ...
  ground_run = createSprite(300,300,10,10);
  ground_run.addAnimation("groundrunning",groundImage);
  ground_run.scale=2;
  ground_run.velocityX=-4;
  
  monkey=createSprite(50,580,10,10);
  monkey.addAnimation("run",monkey_running);
  monkey.scale=0.1;
   
  gro = createSprite(300,595,1100,10);
  gro.visible = false;
...
function obstacles() 
  {
     obstacle = createSprite(600,590,10,10);
